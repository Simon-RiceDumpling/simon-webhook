...
import org.simon.webhook.utils.http.executor.HuToolHttpExecutor;
...
@Component
public class SimonHuToolHttpUtils {
    ...
    public static class HttpCall<T> {
        ...
        public ExecuteResult<T> execute() {
            if (body != null && !body.isEmpty()) {
                ...
                return HuToolHttpExecutor.doExecute(method, url, headers, bodyParams, responseClass);
            } else {
                return HuToolHttpExecutor.doExecute(method, url, headers, params, responseClass);
            }
        }
    }
